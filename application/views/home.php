...
<body>
		...
		<div class="row" style="height: 100vh;">
			<div class="d-flex flex-column align-items-center justify-content-center">
				<div class="mb-4 text-center">
					<h2>Selamat datang di Aplikasi 1</h2>
					<h3 id="name" class="mb-2"></h3>
					<a href="http://localhost/app2_frontend" class="btn btn-primary"><i class="fa-solid fa-arrow-right me-2"></i> Aplikasi 2</a>
				</div>
	...
	<script>
		$(document).ready(e => {
			...
			if( !isLogin ) {
				window.location.href = 'http://localhost/auth_frontend?redirect=app1_frontend'	
			} else {
